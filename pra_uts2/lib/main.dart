...
class _NilaiInputState extends State<NilaiInput> {
            ...
            Padding(
              ...
              child: ClipOval(
                child: Container(
                  ...
                  height: 100,
                  child: Image(
                    image: AssetImage("images/pdam.jpeg"), // Ganti dengan path gambar sesuai kebutuhan
                    fit: BoxFit.cover,
                  ),
                ),
              ),
  ...
  child: Column(
    children: [
      Padding(
        padding: EdgeInsets.symmetric(vertical: 8.0), // Jarak vertikal antara field
        child: TextFormField(
